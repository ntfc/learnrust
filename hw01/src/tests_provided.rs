...
fn test_hanoi_3_disks() {
    ...
    assert_eq!((Peg::A, Peg::C), result[0]);
    assert_eq!((Peg::A, Peg::B), result[1]);
    assert_eq!((Peg::C, Peg::B), result[2]);
    assert_eq!((Peg::A, Peg::C), result[3]);
    assert_eq!((Peg::B, Peg::A), result[4]);
    assert_eq!((Peg::B, Peg::C), result[5]);
    assert_eq!((Peg::A, Peg::C), result[6]);
